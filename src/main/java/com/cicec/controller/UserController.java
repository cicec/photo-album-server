...
public class UserController {
    ...
    List<User> getUserAll() {
        ...
        for (User user : userList) {
            ...
            List<Photo> photoList = photoService.getPhotoListForUser(user);
            user.setAlbumNumber(albumList.size());
            user.setPhotoNumber(photoList.size());
            user.setAvatar(PathConfig.onlineImagePath + "/" + user.getAvatar());
        }
        return userList;
    }
    ...
    public @ResponseBody
    ResponseMessage signIn(@RequestBody User user, HttpSession session) {
        ResponseMessage rm;
    ...
    public @ResponseBody
    ResponseMessage signUp(@RequestBody User user) {
        ResponseMessage rm;
    ...
    public @ResponseBody
    ResponseMessage getUserInfo(HttpSession session) {
    ...
    public @ResponseBody
    ResponseMessage modifyUserInfo(@RequestBody User userInfo, HttpSession session) {
        UserResponseMessage rm;
    ...
    public @ResponseBody
    ResponseMessage signOut(HttpSession session) {
        ResponseMessage rm;
        User user = (User) session.getAttribute("currentUser");
        if (user != null) {
